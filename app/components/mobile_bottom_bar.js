...
const MobileBottomBar = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full bg-[#24244f] shadow-lg flex justify-around items-center p-4 xl:hidden z-10 text-white">
        ...
        <div
          ...
          <div className='w-full max-h-[80vh] overflow-y-auto'>
            <div className="grid grid-cols-1 gap-4 w-full">
              <Link href="/manager" className="relative flex items-center font-semibold justify-center ">
                <svg
                  width="44px"
                  height="44px"
                  viewBox="0 0 24 24"
              ...
              <Link href="/manager/settings" className="relative flex items-center font-semibold justify-center  ">
                <svg
                  width="44px"
                  height="44px"
                  viewBox="0 0 24 20"
              ...
              <Link
                href="/adduser"
                className="relative flex items-center font-semibold justify-center  "
              >
                <svg
                  width="44px"
                  height="44px"
              ...
              <Link
                href="../users" className="relative flex items-center font-semibold justify-center  ">
                <svg
                  fill="#FFFFFF"
                  width="54px"
                  height="54px"
              ...
              <hr />
              {/* Departman Yönetimi */}
              <Link href="/manager/departman" className="relative flex items-center font-semibold justify-center">
                <svg
                  fill="#ffffff"
                  width="44px"
                  height="44px"
              ...
              <Link href="/manager/shift" className="relative flex items-center font-semibold justify-center">
                <svg
                  fill="currentColor"
                  width="32px"
                  height="32px"
              ...
              <hr />
              {/* Takvim Oluştur Butonu */}
              <Link
                href="/manager/duty-calendar"
                className="relative flex items-center font-semibold justify-center"
              >
                <svg
                  width="44px"
              ...
              {/* Geçmiş Nöbetler */}
              <Link href="/manager/past-calendar" className="relative flex items-center font-semibold justify-center">
                <svg
                  width="44px"
                  height="44px"
                  viewBox="0 0 24 24"
      ...
      {/* Kullanıcı Profili */}
      <div>
        <Link href="/manager" className="relative hidden md:block">
          <svg
            width="44px"
            height="44px"
            viewBox="0 0 24 24"
      ...
      <div>
        <Link href="/manager/settings" className="relative hidden md:block">
          <svg
            width="44px"
            height="44px"
            viewBox="0 0 24 20"
      ...
      <div>
        <Link
          href="../users" className="relative hidden md:block">
          <svg
            fill="#FFFFFF"
            width="54px"
            height="54px"
      ...
      <div>
        <Link
          href="/adduser"
          className="relative flex items-center font-semibold hidden md:block"
        >
          <svg
            width="44px"
            height="44px"
      ...
      {/* <div className="mr-[600] md:mr-[0]">
        <ProfileButtonPhoto />
      </div> */}

      {/* Departman Yönetimi */}
      <div className="flex items-center space-x-2 font-semibold">
        <Link href="/manager/departman" className="relative hidden md:block">
          <svg
            fill="#ffffff"
            width="44px"
            height="44px"
      ...
      <Link href="/manager/shift" className="relative hidden md:block">
        <svg
          fill="currentColor"
          width="44px"
          height="44px"
      ...
      <div className="flex items-center space-x-2 text-white font-semibold">
        <Link href="/manager/past-calendar" className="relative hidden md:block">
          <svg
            width="44px"
            height="44px"
            viewBox="0 0 24 24"
