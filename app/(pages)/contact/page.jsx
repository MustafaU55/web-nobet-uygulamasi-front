  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 to-blue-100 py-48 pt-36 text-black">
      <div className="max-w-6xl mx-auto px-4 ">
        <title>İletişim - Nöbet Uygulaması</title>
        <meta
          name="description"
          content="Nöbet Uygulaması ekibine hızlıca ulaşarak iş planlamanız ve takvim çözümleriniz için profesyonel destek alabilirsiniz. Daha fazlası nobetuygulamasi.com'da."
        />
        {/* Favicon (Site logosu) */}
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+90 (539) 685 27 54</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@nobet.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">OMU</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl ">
              ...
              <div className="w-full rounded-lg overflow-hidden">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2994.1037990515897!2d36.210955999999996!3d41.3718295!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40887e9167dd7ecd%3A0xd4c331fd1dbf1413!2sOndokuz%20May%C4%B1s%20%C3%9Cniversitesi!5e0!3m2!1str!2str!4v1781076859347!5m2!1str!2str"
                  width="100%"
                  height="300"
                  style={{ border: 0 }}
                  allowFullScreen=""
