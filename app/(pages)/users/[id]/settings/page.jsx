...
export default function UserProfilePage() {
    ...
    return (
        ...
        <div className="bg-blue-300">
            <SidebarUser />
            <main className="flex-1 xl:ml-[40vh] min-h-screen p-2 sm:p-10 pb-24 bg-gradient-to-r from-blue-300 via-blue-200 to-blue-300 text-black">
                    ...
                    <div className="space-y-4">
                        {editMode ? (
                                ...
                                {['firstname', 'lastname', 'username', 'phoneNumber', 'email', 'adminID'].map((field) => (
                                    <div key={field} className="flex flex-col space-y-1">
                                        ...
                                        <button
                                            ...
                                            className="mt-2 bg-blue-400 text-white font-medium py-2 rounded-lg hover:bg-blue-500 transition"
                                        >
                                            Güncelle
                                        </button>
                                    </div>
                            ...
                            <>
                                ...
                                <div className="flex justify-between items-center">
                                    <p className="text-gray-700 text-lg"><strong>Kayıtlanma Tarihi:</strong> {new Date(userData.created_at).toLocaleDateString()}</p>
                                </div>
                                <div className="flex justify-between items-center">
